package com.ec.spider.proxyspider.WwwXicidailiCom;
...
import com.ec.spider.proxyspider.ProxyCrawl;
@Component
public class WwwXicidailiCom_ATR extends AsyncRestTemplateSpider implements ProxyCrawl {

	@Override
	public String getUrl() {
		return "http://www.xicidaili.com/";
	}
	...
	protected   class SCallback extends AsyncRestTemplateSpider.SCallback {
		...
		public void onSuccess(ResponseEntity<byte[]> result) {
			...
			System.err.println("Sub class SCallback");
			System.err.println("Sub class SCallback");
			System.err.println("Sub class SCallback");
			System.err.println("Sub class SCallback");
			System.err.println("Sub class SCallback");
